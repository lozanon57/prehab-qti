      ...
      <header style={{ backgroundColor: 'var(--color-principal)' }} className="shadow-lg">
        <div className="max-w-2xl mx-auto px-4 py-5">
          ...
          <p className="text-white/75 text-sm leading-relaxed mt-2">
            Tu programa personalizado de preparación y recuperación para la cirugía oncológica.
          </p>
        </div>
      </header>
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-6">
        ...
        <section className="mb-8">
          ...
          <p className="text-sm mb-4" style={{ color: 'var(--color-gris-medio)' }}>
            Programa de prehabilitación — ejercicio, nutrición y bienestar antes de la operación.
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="text-sm mb-4" style={{ color: 'var(--color-gris-medio)' }}>
            Guías y seguimiento para las semanas después de la cirugía.
          </p>
        ...
        >
          ...
          <div className="text-left">
            <p className="font-semibold text-sm" style={{ color: 'var(--color-texto)' }}>
              ¿Qué es ERAS y la prehabilitación?
            </p>
        ...
        <div className="text-center mt-8 pb-6 space-y-1">
          <p className="text-xs font-semibold" style={{ color: 'var(--color-principal)' }}>
            Creador: Dr. Pablo Lozano Lominchar
          </p>
          <p className="text-xs" style={{ color: 'var(--color-gris-medio)' }}>
            Cirujano Oncológico · Instituto Quénet-Torrent
          </p>
          <p className="text-xs" style={{ color: 'var(--color-gris-medio)' }}>
            v1.0 · Mayo 2026
          </p>
